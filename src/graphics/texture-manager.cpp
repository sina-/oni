...
namespace oni {
    namespace graphics {
        ...
        const components::Texture *TextureManager::load(const std::string &path) {
            assert(!path.empty());
            ...
            auto texture = components::Texture{width, height, textureID, format, type, path, uv, {},
                                               components::TextureStatus::READY};
        ...
        components::Texture TextureManager::loadFromData(common::uint16 width, common::uint16 height,
            ...
            // seed.
            return components::Texture{width, height, textureID, format, type, "", uv, data,
                                       components::TextureStatus::READY};
