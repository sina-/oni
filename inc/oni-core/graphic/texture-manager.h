...
namespace oni {
    namespace graphic {
        ...
        public:
             ...
             */
            void updateSubTexture(const component::Texture &texture, common::oniGLint xOffset,
                                  common::oniGLint yOffset, common::oniGLint width,
                                  common::oniGLint height,
                                  const std::vector<common::uint8> &bits);

            const component::Texture *findOrLoad(const std::string &path);

            static component::Texture loadFromData(common::uint16 width, common::uint16 height,
            ...
            // TODO: This function doesnt fit in the current design
            static common::oniGLuint load(const graphic::FontManager &fontManager);
        ...
        private:
            ...
            const component::Texture *load(const std::string &path);
